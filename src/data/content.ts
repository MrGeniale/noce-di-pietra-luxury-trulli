...
export const content: { it: ContentData; en: ContentData } = {
  it: {
    ...
    location: {
      ...
      address: 'Strada Curcio, Zona c, 74015 Martina Franca (TA) - Valle d’Itria, Puglia',
    },
    directBooking: {
    ...
    reviews: {
      ...
      items: [
        {
          name: 'Roberto',
          country: '🇨🇭 Svizzera (Recensione Verificata)',
          text: 'Una vera chicca, complimenti a chi l\'ha appena ristrutturato e a chi lo gestisce: siamo stati benissimo e coccolati! Bellezza e cura dei dettagli, ristrutturazione fatta da maestri trullari con grande finezza, sia nella struttura che nel design interno; e c\'era tutto ciò che serve. Giriamo spesso l\'Europa ma è difficile trovare qualcosa di fatto così bene e con tanta armonia: sembrava di stare in una favola! Un grazie ai fratelli Paola e Francesco e a tutta la famiglia: veri host!',
          highlight: 'Sembrava di stare in una favola: una vera chicca!',
        },
        {
          name: 'Rossella Bellanova',
          country: 'Google Review ★★★★★',
          text: 'Un’esperienza davvero meravigliosa in un trullo ristrutturato di recente con grande cura e attenzione a ogni dettaglio. La splendida pietra a vista, l’arredamento ricercato e l’atmosfera accogliente fanno sentire subito a casa. Pulizia impeccabile, bagno comodo e biancheria romantica e raffinata. La vasca idromassaggio è stata la ciliegina sulla torta: immersa nella natura e nel silenzio, regala momenti di vero relax. Assolutamente consigliato!',
          highlight: 'Tradizione, comfort e vasca idromassaggio da sogno',
        },
        {
          name: 'Ospite Verificato',
          country: 'Booking.com (Voto 10/10)',
          text: 'Splendidi trulli in una tranquilla cornice rurale. Un\'accoglienza calorosa nonostante il nostro arrivo in tarda serata. Paola e i suoi fratelli ci hanno fornito tutto il necessario. Grazie infinite per il meraviglioso tempo trascorso insieme.',
          highlight: 'Trulli fantastici e bellissimi in cornice rurale',
        },
      ],
    },
    faq: {
    ...
    footer: {
      ...
      address: 'Strada Curcio, Zona c, 74015 Martina Franca (TA), Italia',
  ...
  en: {
    ...
    location: {
      ...
      address: 'Strada Curcio, Zona c, 74015 Martina Franca (TA) - Valle d’Itria, Puglia, Italy',
    },
    directBooking: {
    ...
    reviews: {
      ...
      items: [
        {
          name: 'Roberto',
          country: '🇨🇭 Switzerland (Verified Guest)',
          text: 'A true gem, compliments to those who restored and manage it: we felt completely pampered! Beauty and care in every detail, restored with great finesse by master trullari craftsmen. We travel often across Europe, but it is rare to find something made so well and in such harmony: it felt like being in a fairytale! Huge thanks to Paola, Francesco and the entire family: true hosts!',
          highlight: 'Felt like living in a fairytale: a genuine gem!',
        },
        {
          name: 'Rossella Bellanova',
          country: 'Google Review ★★★★★',
          text: 'A truly wonderful experience in a recently renovated trullo with great care in every detail. The exposed limestone, refined furnishings and warm ambiance make you feel right at home. Impeccable cleanliness, romantic linens, and a super functional kitchen. The private jacuzzi was the icing on the cake: immersed in nature and total peace. Absolutely recommended!',
          highlight: 'Tradition, supreme comfort and dreamy hot tub',
        },
        {
          name: 'Verified Guest',
    ...
    footer: {
      ...
      address: 'Strada Curcio, Zona c, 74015 Martina Franca (TA), Italy',
...
export const galleryImages = [
  // Esterni & Trulli (IMG_8220, IMG_8222, IMG_8223, IMG_8225, IMG_8226, IMG_8230)
  {
    id: 1,
    src: '/images/img_8220.jpg',
    category: 'exterior',
    title: { it: 'Corte Esterna & Coni in Pietra', en: 'Limestone Courtyard & Cones' },
    subtitle: { it: 'Scorcio panoramico della struttura', en: 'Panoramic estate view' },
  },
  {
    id: 2,
    src: '/images/img_8222.jpg',
    category: 'exterior',
    title: { it: 'Area Giardino & Relax', en: 'Garden Lounge & Relaxation' },
  ...
  },
  {
    ...
    category: 'exterior',
    title: { it: 'Giardino Privato & Campagna Pugliese', en: 'Private Garden & Countryside' },
    subtitle: { it: 'Oasi di tranquillità tra gli ulivi', en: 'Tranquil haven among olive trees' },
  },
  {
    id: 4,
    src: '/images/img_8225.jpg',
    category: 'exterior',
    title: { it: 'Scorcio della Tenuta', en: 'Estate Panoramic Perspective' },
    subtitle: { it: 'Architettura autentica in pietra viva', en: 'Authentic limestone architecture' },
  },
  {
    id: 5,
    src: '/images/img_8226.jpg',
    category: 'exterior',
    title: { it: 'Crepuscolo sui Trulli', en: 'Trulli at Twilight' },
    subtitle: { it: 'Atmosfera suggestiva al calar del sole', en: 'Evocative sunset ambiance' },
  },
  {
    id: 6,
    src: '/images/img_8230.jpg',
    category: 'exterior',
    title: { it: 'Dettaglio Architettonico dei Coni', en: 'Architectural Details of the Cones' },
    subtitle: { it: 'Tradizione e maestria artigianale', en: 'Tradition and artisanal craft' },
  },

  // Camera Padronale (IMG_8213, IMG_8214)
  {
    id: 7,
  ...
  },
  {
    ...
    subtitle: { it: 'Tessuti raffinati e pietra a vista', en: 'Fine linens & exposed stone' },
  },

  // Idromassaggio (jacuzzi-experience-1, jacuzzi-experience-2, IMG_8224)
  {
    id: 9,
  ...
  // Cucina (IMG_8206, IMG_8205, IMG_8207, IMG_8209, IMG_8212, IMG_8229, IMG_8228)
  {
    id: 12,
    src: '/images/img_8206.jpg',
    category: 'living',
    title: { it: 'Cucina Attrezzata Completa', en: 'Fully Equipped Kitchen' },
    subtitle: { it: 'Elettrodomestici moderni e piano cottura', en: 'Modern appliances and cooktop' },
  },
  {
    id: 13,
    src: '/images/img_8205.jpg',
    category: 'living',
    title: { it: 'Angolo Cottura & Design', en: 'Kitchen Corner & Design' },
    subtitle: { it: 'Spazio funzionale ed elegante', en: 'Functional and elegant space' },
  },
  {
    id: 14,
    ...
    subtitle: { it: 'Arredi di pregio e volte in pietra', en: 'Design furniture & stone arches' },
  },
  {
    id: 15,
    src: '/images/img_8209.jpg',
    category: 'living',
    title: { it: 'Welcome Corner & Macchina Caffè', en: 'Welcome Corner & Coffee Station' },
    subtitle: { it: 'Cialde caffè e prodotti tipici', en: 'Coffee pods and welcome kit' },
  },
  {
    id: 16,
    src: '/images/img_8212.jpg',
    category: 'living',
    title: { it: 'Finiture e Scorcio della Cucina', en: 'Kitchen Finishes & View' },
    subtitle: { it: 'Armonia tra moderno e tradizione', en: 'Harmony of modern and tradition' },
  },
  {
    id: 17,
    src: '/images/img_8229.jpg',
    category: 'living',
    title: { it: 'Tavola & Atmosfera Tipica', en: 'Authentic Table & Dining Setting' },
    subtitle: { it: 'Dettagli per pranzi e cene intime', en: 'Details for intimate dining' },
  },
  {
    id: 18,
    src: '/images/img_8228.jpg',
    category: 'living',
    title: { it: 'Elementi della Tradizione Pugliese', en: 'Traditional Puglian Accents' },
    subtitle: { it: 'Il calore dell’ospitalità autentica', en: 'Warmth of authentic hospitality' },
  },

  // Bagno (IMG_8200, IMG_8201, IMG_8202, IMG_8210, IMG_8227)
  {
    id: 19,
    src: '/images/img_8200.jpg',
    category: 'bathroom',
    title: { it: 'Doccia & Finiture in Pietra', en: 'Walk-in Shower & Stone Finishes' },
  ...
  },
  {
    ...
    subtitle: { it: 'Sanitari sospesi ed eleganza', en: 'Suspended vanity and elegance' },
  },
  {
    id: 22,
    src: '/images/img_8210.jpg',
    category: 'bathroom',
    title: { it: 'Dettagli e Comfort del Bagno', en: 'Bathroom Fixtures & Comfort' },
    subtitle: { it: 'Cura meticolosa in ogni finitura', en: 'Meticulous care in every detail' },
  },
  {
    id: 23,
    src: '/images/img_8227.jpg',
    category: 'bathroom',
    title: { it: 'Set Cortesia & Asciugamani', en: 'Complimentary Toiletries & Towels' },
    subtitle: { it: 'Morbida biancheria per gli ospiti', en: 'Plush linens for our guests' },
  },
];
